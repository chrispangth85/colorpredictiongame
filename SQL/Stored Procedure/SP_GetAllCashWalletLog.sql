...
/****** Object:  StoredProcedure [dbo].[SP_GetAllCashWalletLog]    Script Date: 19/3/2023 11:38:59 AM ******/
DROP PROCEDURE [dbo].[SP_GetAllCashWalletLog]
GO
...
CREATE PROCEDURE [dbo].[SP_GetAllCashWalletLog]
(
	@viewPage	INT,
